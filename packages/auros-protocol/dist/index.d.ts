...
type WebhookEventType = AlertType | "regulatory.update" | "green.index.changelog" | "chargeflow.unit.minted" | "chargeflow.unit.retired";
type MonitorRequest = {
    asset_type: AssetType;
    jurisdiction: string;
    structure?: "spv" | "fund" | "trust" | "other";
...
type ChargeflowFromOcpiResponse = ChargeflowBatchResponse & {
    source: "ocpi_stub";
    disclaimer: string;
};
