...
export const fr: Messages = {
  ...
  hero: {
    eyebrow: "Liquidité pour l’économie réelle",
    title: "Le moteur de liquidité des ressources critiques.",
    subtitle:
      "Marchés de grade institutionnel pour les actifs numériques — et couche de règlement pour l’énergie, l’eau et le compute tokenisés.",
    ctaPrimary: "Parler à l’équipe",
    ctaEstimate: "Dossier RWA",
    ctaProof: "Preuves & API",
    doorDossierLabel: "Je prépare un dossier",
    doorDossierHint: "Porteur d’actif · ~4 à 12 min · sans être expert",
    doorProofLabel: "Je vérifie / j’intègre",
    doorProofHint: "Banque, flotte, dev · Shield, CFU, OpenAPI",
    firstWinLabel: "Essayer Energy Lab",
