...
export const es: Messages = {
  ...
  hero: {
    eyebrow: "Liquidez para activos reales",
    title: "El motor de liquidez de los recursos críticos del mundo.",
    subtitle:
      "Mercados de grado institucional para activos digitales — y la capa de liquidación para energía, agua y compute tokenizados.",
    ctaPrimary: "Hablar con el equipo",
    ctaEstimate: "Expediente RWA",
    ctaProof: "Pruebas y API",
    doorDossierLabel: "Preparo un expediente",
    doorDossierHint: "Titular · ~4–12 min · sin ser experto",
    doorProofLabel: "Verifico / integro",
    doorProofHint: "Banco, flota, eng · Shield, CFU, OpenAPI",
    firstWinLabel: "Probar Energy Lab",
