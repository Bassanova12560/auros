...
export const en: Messages = {
  ...
  hero: {
    eyebrow: "Liquidity for real assets",
    title: "The liquidity engine for the world's most critical resources.",
    subtitle:
      "Institutional-grade markets for digital assets — and the settlement layer for tokenized energy, water, and compute.",
    ctaPrimary: "Talk to our team",
    ctaEstimate: "RWA dossier",
    ctaProof: "Proofs & API",
    doorDossierLabel: "I’m preparing a dossier",
    doorDossierHint: "Asset owner · ~4–12 min · no blockchain expertise",
    doorProofLabel: "I verify / integrate",
    doorProofHint: "Bank, fleet, eng · Shield, CFU, OpenAPI",
    firstWinLabel: "Try Energy Lab",
