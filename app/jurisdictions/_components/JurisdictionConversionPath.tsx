...
export function JurisdictionConversionPath() {
  ...
  return (
    <section className="py-16 md:py-20">
      ...
      <ol className="green-hub-fade-in mt-10 grid gap-8 md:grid-cols-4 md:gap-6">
        {p.steps.map((step, index) => (
          <li key={step.title} className="jurisdiction-path-step">
      ...
      <BezelCard className="green-hub-fade-in-delay mt-10" innerClassName="px-5 py-4 md:px-6 md:py-5" animate>
