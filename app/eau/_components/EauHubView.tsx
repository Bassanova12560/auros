...
export function EauHubView() {
  ...
  const moreLinks = [
    { href: "/eau/trust", label: locale === "en" ? "WETS hub" : "Accueil WETS" },
    { href: "/eau/trust/console", label: locale === "en" ? "WETS console" : "Console WETS" },
    { href: "/eau/risk", label: locale === "en" ? "WELHR risk score" : "Score WELHR" },
    { href: "/eau/continuity", label: locale === "en" ? "Continuity playbook" : "Playbook continuité" },
    { href: "/compass", label: "Compass" },
    { href: "/demos/data-center-100mw", label: locale === "en" ? "DC 100 MW demo" : "Démo 100 MW" },
  ...
  return (
    <MobilePageShell width="3xl">
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        ...
        <PrimaryButton href="/eau/trust/console" variant="ghost">
          {locale === "en"
            ? "Console"
            : locale === "es"
              ? "Consola"
