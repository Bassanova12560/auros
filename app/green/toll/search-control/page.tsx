...
/** Local copies — avoid importing `@/lib/toll/search-control` (node:fs) into the client bundle. */
...
const SEARCH_VISIBILITIES = ["public", "partial", "private"] as const;
type SearchAudience = (typeof SEARCH_AUDIENCES)[number];
type SearchVisibility = (typeof SEARCH_VISIBILITIES)[number];
