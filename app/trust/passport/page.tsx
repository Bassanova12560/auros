...
export const metadata: Metadata = {
  title: "Lifestyle Passport | AUROS",
  description:
    "Passeport d’admission pour RWA patrimoine — immobilier, luxe, véhicules, bateaux, droits sportifs. Titre, custody, assurance, claim vs title.",
};
...
export default function LifestylePassportPage() {
  return (
    <FocusPageShell path={TRUST_PASSPORT_ROUTE} width="3xl">
      <ContentPageLayout
      ...
      >
        ...
        <section className="space-y-3 text-sm text-white/55">
          <p>
            ...
            <em className="text-white/70">registre</em> réémet au vrai
            propriétaire. Le lifestyle sans filet = possession du token sans
            titre.
          </p>
        </section>
