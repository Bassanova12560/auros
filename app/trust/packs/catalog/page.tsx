...
import { TRUST_PACKS_WELCOME_PATH } from "@/lib/vertical-welcome/config";

import { PackGradeBadge, TrustPacksNav } from "../_components/PackUi";

export const metadata: Metadata = {
  title: "Catalogue Trust Packs | AUROS",
  description: "Catalogue des packs et rapports publiés.",
};
...
export default async function TrustPacksCatalogPage() {
  ...
  return (
    <FocusPageShell path={`${TRUST_PACKS_ROUTE}/catalog`} width="3xl">
      <ContentPageLayout
        product="Trust"
        eyebrow="Asset Trust Packs"
        title="Catalogue & rapports"
        intro="7 verticaux — scarcity et lifestyle. Chaque pack exige des preuves pour monter le grade."
        cta={{ href: `${TRUST_PACKS_ROUTE}/new`, label: "Nouvel assessment" }}
      >
        <TrustPacksNav />

        <section className="space-y-4">
          <h2 className="font-display text-lg text-white">Packs</h2>
        ...
        <section className="mt-12 space-y-3">
          <h2 className="font-display text-lg text-white">Rapports publiés</h2>
          {error ? (
        ...
        <div className="mt-10">
          <PrimaryButton href={TRUST_PACKS_WELCOME_PATH} variant="ghost">
            Accueil Trust Packs
          </PrimaryButton>
        </div>
