...
export function CapacityRightsGuideView() {
  const qs = questionsForPack("capacity_rights");

  return (
    <FocusPageShell path={TRUST_CAPACITY_GUIDE_PATH} width="3xl">
      <ContentPageLayout
        product="Trust · Scarcity"
        eyebrow="Futur non soupçonné"
        title="Capacity rights — guide"
      ...
      >
        ...
        <section className="space-y-3 text-sm leading-relaxed text-white/55">
          <p>
            Eau et watts convergent ici : sans COD crédible et sans instrument opposable, la
            « capacité papier » est le nouveau greenwashing énergétique.
          </p>
          <p>
            Le pack Capacity Rights reprend la même discipline que WETS (preuves sourcées) et se
            branche sur Shield / verify pour l’admission plateforme.
          </p>
        </section>
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          <PrimaryButton href={TRUST_CAPACITY_WELCOME_PATH} variant="ghost">
            Accueil Capacity
          </PrimaryButton>
