...
export function InstitutionsIndexView() {
  return (
    <FocusPageShell path={TRUST_INSTITUTIONS_INDEX_PATH} width="3xl">
      <ContentPageLayout
      ...
      >
        ...
        <p className="mt-10 text-xs text-amber-200/70">{INSTITUTION_INDEX_DISCLAIMER}</p>

        <div className="mt-8 flex flex-wrap gap-3">
          <PrimaryButton href={TRUST_INSTITUTIONS_WELCOME_PATH} variant="ghost">
            Accueil Institutions
          </PrimaryButton>
          <PrimaryButton href={TRUST_PACKS_WELCOME_PATH}>Trust Packs</PrimaryButton>
